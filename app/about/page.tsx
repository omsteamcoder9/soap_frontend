...
export async function generateMetadata(): Promise<Metadata> {
  const storeName = process.env.NEXT_PUBLIC_SITE_NAME || 'Sastika Fashion and Fancy Store';
  ...
  return {
    ...
    description: `Discover ${storeName}'s story, mission, and values. Learn about our journey in providing fashion and fancy products.`,
    keywords: ['about Sastika', 'our story', 'organic fashion company', 'Sastika mission', 'our team', storeName],
    robots: { index: true, follow: true },
    openGraph: {
      type: 'website',
      url: `${siteUrl}/about`,
      title: `About Us | ${storeName}`,
      description: `Learn about ${storeName}'s mission to provide fashion and fancy natural skincare products.`,
      siteName: storeName,
...
function generateStructuredData() {
  ...
  return {
    ...
    "@type": "AboutPage",
    "name": "About Us",
    "description": "Learn about our fashion company's mission, values, and team",
    "url": `${siteUrl}/about`,
    "publisher": {
      "@type": "Organization",
      "name": storeName,
      "description": "Sastika Fashion and Fancy company",
      "url": siteUrl,
...
const AboutPage: React.FC = () => {
  ...
  const teamMembers: TeamMember[] = [
    {
      ...
      name: 'John Doe',
      role: 'CEO & Founder',
      bio: `John has over 10 years of experience in organic skincare and founded ${storeName} with a vision to provide natural, chemical-free fashion products.`,
      image: '/images/m1.png'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      bio: 'Mike creates beautiful and effective fashion formulations using natural ingredients and traditional methods.',
      image: '/images/m1.png'
    }
  ];
  ...
  const stats = [
    ...
    { number: '100+', label: 'Fashion Varieties' },
      ...
      <div className="min-h-screen bg-[#fafaf9] text-stone-800 font-sans selection:bg-stone-200">
        ...
        <section className="relative pt-32 pb-20 overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative z-10 text-center">
                <span className="inline-block py-1.5 px-4 mb-6 text-[10px] font-bold tracking-[0.2em] uppercase text-[#D4AF37] bg-white border border-[#D4AF37] rounded-full shadow-sm">
                ...
                <h1 className="text-5xl md:text-8xl font-serif font-light mb-8 tracking-tight leading-none text-stone-900">
                   Sastika <br/> <span className="italic font-normal text-[#D4AF37]">Fashion And Fancy.</span>
                </h1>
                <p className="max-w-2xl mx-auto text-lg md:text-xl text-stone-600 leading-relaxed font-light">
                    {storeName} is dedicated to providing , products made with traditional methods and premium ingredients.
                </p>
            </div>
        </section>
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <div className="space-y-10 order-1 lg:order-2">
                ...
                <div className="space-y-6 text-lg text-stone-600 leading-relaxed">
                    <p>
                        Our mission is to make quality organic fashion products accessible to everyone while providing
                        an exceptional skincare experience. We believe in the power of natural ingredients to
                        transform skin health.
                    </p>
                    <p className="font-light">
                        We craft our fashion products with care, ensuring every product we offer meets
                        the highest standards of purity and provides genuine benefits to our customers.
                    </p>
                </div>

                <div className="p-8 bg-[#D4AF37]/10 border-l-8 border-[#D4AF37] italic text-xl text-stone-700 font-serif leading-relaxed shadow-sm">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-12 md:gap-8">
              {stats.map((stat, index) => (
                <div key={index} className="text-center group">
                  <div className="text-5xl md:text-6xl font-serif mb-3 text-[#D4AF37] group-hover:scale-110 transition-transform duration-500">
                    {stat.number}
                  </div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-12">
              {teamMembers.map((member) => (
                ...
                >
                  <div className="absolute -top-12 -right-12 w-32 h-32 bg-[#D4AF37]/10 rounded-full transition-transform group-hover:scale-[3] duration-700" />
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-xs font-bold text-[#D4AF37] uppercase tracking-[0.2em] mb-6">{member.role}</p>
          ...
          <div className="relative bg-[#1c1917] rounded-[3.5rem] overflow-hidden group">
            ...
            <div className="relative z-10 grid lg:grid-cols-2 items-center">
              <div className="p-12 md:p-24 space-y-10 text-left">
                <div className="space-y-4">
                  ...
                  <h2 className="text-5xl md:text-7xl font-serif text-stone-50 leading-[1.1]">
                    Experience Product of <br/> 
                    <span className="italic text-[#D4AF37]">Sastika Fashion and Fancy</span>
                  </h2>
                </div>
                <div className="flex flex-wrap gap-6 items-center">
                  ...
                  <Link 
                    href="/" 
                    className="bg-[#D4AF37] text-stone-900 px-10 py-5 rounded-full font-bold uppercase tracking-widest text-[11px] hover:bg-[#E6BF4F] transition-all hover:-translate-y-1 shadow-2xl inline-block"
                  >
                    Explore Fashion
                  </Link>
              ...
              <div className="relative h-[400px] lg:h-full min-h-[500px] overflow-hidden">
                ...
                <Image
                  src="/images/m3.avif"
                  alt="Sastika Fashion and Fancy Experience"
                  fill
                  className="object-cover transition-transform duration-[3000ms] group-hover:scale-110"
                />
                <div className="absolute top-10 right-10 z-20 bg-[#D4AF37]/20 backdrop-blur-md border border-[#D4AF37]/30 p-4 rounded-full w-24 h-24 flex items-center justify-center text-center rotate-12">
            ...
            <div className="absolute bottom-[-10%] left-[-5%] w-64 h-64 bg-[#D4AF37]/10 blur-[100px] rounded-full" />
          </div>
        </section>
      </div>
    </>
