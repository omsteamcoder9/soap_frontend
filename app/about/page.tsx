...
const AboutPage: React.FC = () => {
  ...
  return (
    <>
      <Head>
        <title>About Us - soap</title>
        <meta name="description" content="Learn more about soap, our mission, and team" />
      </Head>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-gray-700 mb-8">
                We are passionate about bringing the joy of reading to soap lovers everywhere.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Our mission is to make quality soaps accessible to everyone while providing 
                ...
                <p className="text-lg text-gray-700">
                  We curate our collection with care, ensuring every soap we offer meets 
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700">
                The passionate bibliophiles behind soap
              </p>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-700 max-w-2xl mx-auto">
                The principles that guide everything we do at soap
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-300">
                ...
                <p className="text-gray-700">
                  We carefully select every soap to ensure it meets our high standards of content and production quality.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-300">
                ...
                <p className="text-gray-700">
                  We believe in building a community of readers who share their love for soaps and learning.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-md border border-gray-300">
                ...
                <p className="text-gray-700">
                  We ensure quick and reliable delivery so you can start reading your new soaps as soon as possible.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-gradient-to-r from-gray-800 to-gray-700">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-100 mb-8 max-w-2xl mx-auto">
              Join thousands of satisfied readers who have found their perfect soaps with us.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/products"
                className="bg-white text-gray-900 px-8 py-3 rounded-lg hover:bg-gray-100 font-semibold transition-all duration-200 shadow-lg hover:shadow-xl"
              >
                Browse soaps
              </Link>
              <Link 
                href="/contact"
                className="bg-transparent border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-gray-900 font-semibold transition-all duration-200"
              >
                Contact Us
              </Link>
            </div>
