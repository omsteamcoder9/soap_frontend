...
export default function ContactForm() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-[#f2f2f2] rounded-lg shadow-lg border border-gray-300">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-gray-600 transition-all duration-200 cursor-text"
        ...
        <div>
          ...
          <textarea
            ...
            required
            rows={6}
            className="w-full px-4 py-3 bg-white border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-600 focus:border-gray-600 transition-all duration-200 resize-vertical cursor-text"
