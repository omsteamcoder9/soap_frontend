            ...
            <p className="mt-2 text-gray-600 text-lg lg:text-base">
              {isGuestUser ? (
                ...
                <>
                  ...
                  <Link
                    href="/login"
                    className="font-semibold text-gray-700 hover:text-gray-600 transition-colors duration-200"
                  >
                    Sign in
                  </Link>
                </>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-700 focus:border-gray-700 transition-all duration-200 placeholder-gray-400"
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className="w-full px-4 py-3 text-sm sm:text-base border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-700 focus:border-gray-700 transition-all duration-200 placeholder-gray-400 disabled:bg-gray-50 disabled:text-gray-500"
            ...
            {isGuestUser && showPasswordFields && (
              <div className="text-center">
                <button
                  ...
                  className="text-xs sm:text-sm text-gray-700 hover:text-gray-600 font-medium transition-colors duration-200"
                >
                  ← Back to basic info
                </button>
              </div>
