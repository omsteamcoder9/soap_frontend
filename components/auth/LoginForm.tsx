        ...
        <div className="max-w-md mx-auto bg-white rounded-lg shadow-md border border-gray-200 p-8">
          ...
          <form onSubmit={handleLogin}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-700 focus:border-gray-700 transition-all duration-200"
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <Link href="/signup" className="text-gray-700 hover:text-gray-600 font-semibold transition-colors duration-200">
                Create an account
              </Link>
            </p>
          </div>
