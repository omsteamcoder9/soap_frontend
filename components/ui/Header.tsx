          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
              <button
                ...
                className="xl:hidden p-1.5 text-gray-700 hover:text-gray-900 transition-all duration-200 hover:bg-gray-100 rounded-lg cursor-pointer"
            ...
            <nav className="hidden xl:flex items-center space-x-4 2xl:space-x-6">
              <Link 
                href="/" 
                className="text-gray-700 hover:text-gray-900 transition-all duration-200 font-medium px-3 py-2 rounded-lg hover:bg-gray-100 border-b-2 border-transparent hover:border-gray-300 text-sm 2xl:text-base cursor-pointer"
              >
                Home
              </Link>
      ...
      <div className="flex items-center justify-between">
        ...
        <p className="text-gray-700 font-medium text-sm">₹{product.price}</p>
                  ...
                  <button 
                    ...
                    className="p-1.5 text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200 rounded-lg cursor-pointer"
              ...
              <Link 
                href="/cart"
                className="p-1.5 text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200 rounded-lg relative group cursor-pointer"
              >
                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                {user ? (
                  <div className="relative">
                    <button
                      ...
                      className="flex items-center space-x-1 sm:space-x-2 text-gray-700 hover:text-gray-900 transition-all duration-200 hover:bg-gray-100 rounded-lg p-1.5 cursor-pointer"
                    >
                      <div className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 bg-gray-100 rounded-full flex items-center justify-center text-gray-700 font-bold text-xs md:text-sm shadow border border-gray-300">
                  ...
                  <div className="flex items-center space-x-1 sm:space-x-2">
                    <Link
                      href="/signup"
                      className="bg-gray-700 text-white px-2 py-1.5 rounded-md hover:bg-gray-800 transition-all duration-200 font-medium shadow hover:shadow-lg text-xs sm:text-sm whitespace-nowrap cursor-pointer min-w-[45px] sm:min-w-[50px] text-center"
                    >
                      Sign Up
                    </Link>
                  </div>
                ...
                <div className="flex flex-col h-full">
                  ...
                  <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="text-lg font-bold text-gray-900">soap</span>
                      </div>
                    </Link>
                    <button
                      onClick={() => setIsMobileMenuOpen(false)}
                  ...
                  <nav className="flex-1 p-4 overflow-y-auto">
                    <div className="space-y-1">
                      <Link 
                        href="/" 
                        className="flex items-center space-x-3 text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200 font-medium p-3 rounded-lg border border-transparent hover:border-gray-300 text-sm cursor-pointer"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      {!loading && categories.map((category) => (
                        <Link
                          key={category._id}
                          href={`/products?category=${category.slug}`}
                          className="flex items-center space-x-3 text-gray-700 hover:text-gray-900 hover:bg-gray-100 transition-all duration-200 font-medium p-3 rounded-lg border border-transparent hover:border-gray-300 text-sm cursor-pointer ml-3"
                          onClick={() => setIsMobileMenuOpen(false)}
                        >
                          <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="p-4 border-t border-gray-200">
                    {user ? (
                      <div className="flex items-center space-x-3 p-2">
                        <div className="w-8 h-8 bg-gray-100 rounded-full flex items-center justify-center text-gray-700 font-bold text-sm border border-gray-300">
                          {user.email?.charAt(0).toUpperCase()}
                        </div>
                      ...
                      <div className="flex space-x-2">
                        <Link
                          href="/login"
                          className="flex-1 text-center bg-gray-100 text-gray-700 py-2 rounded-lg hover:bg-gray-200 transition-all duration-200 text-sm font-medium"
                          onClick={() => setIsMobileMenuOpen(false)}
                        >
                          Login
                        </Link>
                        <Link
                          href="/signup"
                          className="flex-1 text-center bg-gray-700 text-white py-2 rounded-lg hover:bg-gray-800 transition-all duration-200 text-sm font-medium"
                          onClick={() => setIsMobileMenuOpen(false)}
                        >
                          Sign Up
                        </Link>
      ...
      `}>
        <div className="container mx-auto px-2">
          <div className="flex items-center justify-between h-14">
            ...
            <Link 
              href="/" 
              className="flex flex-col items-center justify-center flex-1 p-1 text-gray-700 hover:text-gray-900 transition-all duration-200 cursor-pointer min-w-0"
            ...
            <Link 
              href="/cart"
              className="flex flex-col items-center justify-center flex-1 p-1 text-gray-700 hover:text-gray-900 transition-all duration-200 relative cursor-pointer min-w-0"
              onClick={() => setIsFooterVisible(false)}
            >
              <svg className="w-4 h-4 mb-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z" />
              ...
              {cartItemsCount > 0 && (
                <span className="absolute top-0 right-4 bg-gray-700 text-white text-[10px] rounded-full h-3 w-3 flex items-center justify-center font-bold shadow border border-gray-800">
                  {cartItemsCount > 9 ? '9+' : cartItemsCount}
                </span>
              )}
            ...
            {user ? (
              <Link 
                ...
                onClick={() => setIsFooterVisible(false)}
              >
                <div className="w-4 h-4 bg-gray-100 rounded-full flex items-center justify-center text-gray-700 font-bold text-[10px] mb-0.5 border border-gray-300">
                  {user.email?.charAt(0).toUpperCase()}
                </div>
              ...
              <div className="flex flex-col items-center justify-center flex-1 p-1 min-w-0">
                <div className="flex flex-col items-center">
                  <div className="flex space-x-1">
                    <Link
                      href="/signup"
                      className="px-1.5 py-1 bg-gray-700 text-white text-[10px] font-medium rounded hover:bg-gray-800 transition-all duration-200 text-center cursor-pointer"
                      onClick={() => setIsFooterVisible(false)}
                    >
                      Signup
                    </Link>
